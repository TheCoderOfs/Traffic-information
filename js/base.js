$(function () {
    ...
    //echart_1重庆各市货运量
    function echart_1() {
        //http://tjj.cq.gov.cn/zwgk_233/tjnj/数据来源
            ...
            series: [
                {
                    name: '总货运量',
                    type: 'line',
                    data: [121389, 144254.39, 135432.72, 150452.98, 149432.82]
                },
                {
                    name: '铁路货运量',
                    type: 'line',
                    data: [1878.45, 1592.82, 1828.08, 1628.08, 1728.81]
                },
                {
                    name: '公路货运量',
                    type: 'line',
                    data: [99679.00, 121185.16, 111914.65, 113964.33, 123114.95]
                },
                {
                    name: '水路货运量',
                    type: 'line',
                    data: [19819.14, 21461.83, 21677.69, 22673.54, 21397.69]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echart_8() {
        ...
        option = {
            ...
            legend: {
                data: ['铁路货物周转量', '公路货物周转量', '水路货物周转量', '总计货物周转量'],
                textStyle: {
                    color: '#fff'
                },
                top: '4%'
            ...
            series: [
                {
                    name: '铁路货物周转量',
                    type: 'line',
                    data: [196.61, 246.66, 292.17, 322.47, 368.96]
                },
                {
                    name: '公路货物周转量',
                    type: 'line',
                    data: [1055.45, 1155.84, 1063.30, 1167.34, 1148.30]
                },
                {
                    name: '水路货物周转量',
                    type: 'line',
                    data: [2270.47, 2435.94, 2513.22, 2646.72, 2613.49,]
                },
                {
                    name: '总计货物周转量',
                    type: 'line',
                    data: [3524.70, 3841.66, 3871.90, 4065.28, 3986.72]
                },
            ]
        };
        myChart.setOption(option);
            ...
            series: [
                {
                    ...
                    data: [
                        { value: 149432.82, name: '2024年货运量(149432.82)' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 1728.81, name: '铁路' },
                        { value: 123114.95, name: '公路' },
                        { value: 21397.69, name: '水路' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 54911.94, name: '2023年货运量(150452.98)' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 1628.08, name: '铁路' },
                        { value: 113964.33, name: '公路' },
                        { value: 22673.54, name: '水路' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 135432.72, name: '2022年货运量(135432.72)' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 1828.08, name: '铁路' },
                        { value: 111914.65, name: '公路' },
                        { value: 21677.69, name: '水路' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 144254.39, name: '2021年业务量(144254.39)' },
                    ]
                },
                {
                    name: '货运量(万吨)',
                    ...
                    data: [
                        { value: 1592.82, name: '铁路' },
                        { value: 121185.16, name: '公路' },
                        { value: 21461.83, name: '水路' },
                    ]
                },
            ]
        };
            ...
            series: [
                {
                    ...
                    data: [
                        { value: 617.42, name: '2024年公路营运拥有量(617.42)' },
                    ]
                },
                {
                    name: '汽车拥有量(万辆)',
                    ...
                    data: [
                        { value: 534.32, name: '公路营运载客' },
                        { value: 58.68, name: '公路营运载货' },
                    ]
                },
                {
                    name: '公路营运',
                    ...
                    data: [
                        { value: 606.40, name: '2023年公路营运拥有量(606.40)' }
                    ]
                },
                {
                    name: '汽车拥有量(万辆)',
                    ...
                    data: [
                        { value: 528.31, name: '公路营运载客' },
                        { value: 57.29, name: '公路营运载货' },
                ...
                },
                {
                    ...
                    data: [
                        { value: 576.40, name: '2022年公路营运拥有量(576.40)' },
                ...
                },
                {
                    ...
                    data: [
                        { value: 518.69, name: '公路营运载客' },
                        { value: 54.69, name: '公路营运载货' },
                        // {value:137.96, name:'2014年公路营运载客汽车拥有量(万辆)'},
                        // {value:2.65, name:'2014年公路营运载货汽车拥有量(万辆)'},
                        // {value:131.48, name:'2013年公路营运载客汽车拥有量(万辆)'},
                        // {value:2.97, name:'2013年公路营运载货汽车拥有量(万辆)'}
                ...
                },
                {
                    ...
                    data: [
                        { value: 545.42, name: '2021年公路营运拥有量(545.42)' },
                    ]
                },
                {
                    name: '汽车拥有量(万辆)',
                    ...
                    data: [
                        { value: 488.85, name: '公路营运载客' },
                        { value: 53.57, name: '公路营运载货' },
                        // {value:137.96, name:'2014年公路营运载客汽车拥有量(万辆)'},
                        // {value:2.65, name:'2014年公路营运载货汽车拥有量(万辆)'},
                        // {value:131.48, name:'2013年公路营运载客汽车拥有量(万辆)'},
                        // {value:2.97, name:'2013年公路营运载货汽车拥有量(万辆)'}
