$(function () {
                ...
                series: [
                    {
                        ...
                        data: [0,2443443, 2488089, 2745242, 2975840]
                    },
                    {
                        name: '民航货物',
                        type: 'bar',
                        ...
                        data: [0,660195, 756980,668125, 673927, 3371.82]
                    },
                    
                    {
                        ...
                        data: [0,2656831, 2744131, 2254273, 2290874]
                    },
                    {
                        name: '管道货物',
                        type: 'bar', barWidth: "10%",
                        
                        data: [0,2667136, 2814673, 3144850, 3361351]
                    },
                    {
                        name: '总计',
                        type: 'bar',
                        barWidth: "10%",
                        data: [0,8427606, 8803872, 8812490, 9071394]
                    },
    ...
    function echart_5() {
        ...
        function showProvince() {
            var geoCoordMap = {
                '北京首都国际机场': [116.60,40.08],
                '北京大兴国际机场': [116.43,39.51],
                '北京八达岭机场':[115.94,40.38],
                '北京密云机场':[116.89,40.40]
            };
            var data = [{
                name: '北京首都国际机场',
